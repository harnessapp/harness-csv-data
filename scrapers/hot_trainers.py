...
OUTPUT_FILE = REPO_ROOT / "Hot Trainers.csv"
...
# Sort so most recent runs appear first per trainer
...
if hot_trainers_df.empty:
    print("⚠️ No trainers met criteria (MIN_STARTS=100 in last 365 days). Writing empty CSV.")
...
print("✅ Hot Trainers CSV created!")
