...
file_name = "Cold Trainers.csv"  # Ensure this is your intended output file
...
# Create a new DataFrame for Cold Trainers
cold_trainers = []
...
cold_trainers_df = cold_trainers_df.sort_values(by=['Wins', '2nds', '3rds'], ascending=[True, True, True])
...
print(f"Cold Trainers CSV has been created, filtered by {state_filter}!")
